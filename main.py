...
class Chunk_Announcer:
    def __init__(self):
        ...
        self.chunk_size = 1024  # Specify the size of each chunk in bytes (change as needed)
        ...
        self.broadcast_port = 8000  # Specify the port number to use for broadcasting (change as needed)
    ...
    def divide_file_into_chunks(self):
        ...
        for i in range(self.num_chunks):
            ...
            chunk_name = f"{os.path.basename(self.file_path)}.chunk{i}"
    ...
    def broadcast_chunks(self):
        while True:
            ...
            time.sleep(60)  # Wait for 60 seconds before broadcasting again
        ...
        while True:
            ...
            for chunk in message['chunks']:
                ...
                if sender_ip not in self.content_dict[chunk]:
                    ...
                    print(sender_ip + ": " + ", ".join(self.content_dict[chunk]) + " has " + chunk)
